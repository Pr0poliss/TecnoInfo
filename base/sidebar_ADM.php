    ...
    <ul>
        ...
        <li>
            <a href="?page=relatorio" class="<?= ($_GET['page'] == 'relatorio') ? 'active' : ''; ?>">
                <img src="../img/icons/relatorio.png" alt="Visão Geral" class="icon">Relatório
            </a>
        </li>
        <li>
            <a href="?page=perfil" class="<?= ($_GET['page'] == 'perfil') ? 'active' : ''; ?>">
                <img src="../img/icons/adm.png" alt="Visão Geral" class="icon">Perfil
            </a>
        </li>
        <li>
            <a href="?page=listarAdm" class="<?= ($_GET['page'] == 'listarAdm') ? 'active' : ''; ?>">
                <img src="../img/icons/aluno.png" alt="adm" class="icon">Administradores
            </a>
        </li>
        <li>
            <a href="?page=listarUsu" class="<?= ($_GET['page'] == 'listarUsu') ? 'active' : ''; ?>">
                <img src="../img/icons/aluno.png" alt="Usuários" class="icon">Usuários
            </a>
        </li>
        <li>
            <a href="?page=listarUni" class="<?= ($_GET['page'] == 'listarUni') ? 'active' : ''; ?>">
                <img src="../img/icons/unidade.png" alt="unidade" class="icon">Unidades
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="?page=listarPlano" class="<?= ($_GET['page'] == 'listarPlano') ? 'active' : ''; ?>">
                <img src="../img/icons/plano.png" alt="plano" class="icon"> Planos
            </a>
        </li>
        <li>
            <a href="?page=listarPag" class="<?= ($_GET['page'] == 'listarPag') ? 'active' : ''; ?>">
                <img src="../img/icons/pagamento.png" alt="Visão Geral" class="icon">Pagamentos
            </a>
        </li>
        <li>
