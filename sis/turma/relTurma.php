<?php
require_once __DIR__ . '/../../vendor/autoload.php'; // Caminho correto para o autoloader
...
if ($result->num_rows > 0) {
    $html .= '
        ...
        <th>Nome do tutor resposável</th>
        </tr></thead>
        <tbody>';
...
$mpdf->Output(__DIR__ . '/litarTurma.php', \Mpdf\Output\Destination::INLINE); // GERA E ENVIA O PDF PARA O NAVEGADOR

exit; //ENCERRA O SCRIPT PARA EVITAR RENDERIZAR MAIS CONTEÚDO NA PÁGINA